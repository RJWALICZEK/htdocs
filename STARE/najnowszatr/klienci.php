...
$(document).ready(function(){
    $("#myForm").submit(function(event){
        ...
        // Nie trzeba już return false, bo event.preventDefault() zrobił robotę
    });
});
</script>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                if(isset($_SESSION['login'])){
                    ...
                    echo "<a class='edit' href='editklienta.php?id=".$row["id"]."'> E </a>";
                };
                echo "</td></tr>\n";
            }
        } else {
...
<form action="dodaj_klienta.php" method="post" id="myForm">
